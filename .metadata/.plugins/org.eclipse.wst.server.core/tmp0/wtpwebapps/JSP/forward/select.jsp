...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-35" data-genuitec-path="/JSP/WebContent/forward/select.jsp">
	<form action="control.jsp" method="get" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-35" data-genuitec-path="/JSP/WebContent/forward/select.jsp">
		보고 싶은 페이지 : 
		<select name="page">
