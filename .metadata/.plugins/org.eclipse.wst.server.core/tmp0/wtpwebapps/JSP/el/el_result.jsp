...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-27" data-genuitec-path="/JSP/WebContent/el/el_result.jsp">
	before : <%= request.getAttribute("name") %><br data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-27" data-genuitec-path="/JSP/WebContent/el/el_result.jsp">
	after : ${name}<br><br>
