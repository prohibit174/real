...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc4-6" data-genuitec-path="/myBatis/WebContent/updateForm.jsp">
	<form action="updateAction.jsp" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc4-6" data-genuitec-path="/myBatis/WebContent/updateForm.jsp">
