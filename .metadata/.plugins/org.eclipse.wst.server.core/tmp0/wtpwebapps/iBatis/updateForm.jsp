...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-5" data-genuitec-path="/iBatis/WebContent/updateForm.jsp">
	<form action="updateAction.jsp" method="post" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-5" data-genuitec-path="/iBatis/WebContent/updateForm.jsp">
