...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc5-0" data-genuitec-path="/BoardProject/WebContent/detail.jsp">
	<h3 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc5-0" data-genuitec-path="/BoardProject/WebContent/detail.jsp">글세부보기</h3>
	<table border="1">
		<tr height="30">
			<td width="150">글번호</td>
