...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-2" data-genuitec-path="/JSP/WebContent/JSPFolder/application.jsp">
<%
	String path = "/message/notice.txt";
	String pathFull = application.getRealPath(path);
	
	try{
		BufferedReader br = new BufferedReader(new FileReader(pathFull));
		String str = "";
