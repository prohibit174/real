...
<body>
	...
	<table border="1" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="board" items="${list}">
			<tr height="30">
				...
				<td align="left"><c:if test="${board.b_level>0 }">
				...
				<td align="center"><fmt:formatDate value="${board.b_date }"
	...
	<form action="list.jsp" method="post">
		<input type="hidden" name="temp" value="temp"></input> <input
			type="checkbox" name="area" value="b_title">제목</input> <input
			type="checkbox" name="area" value="b_name">작성자</input> <input
