 ...
 * Generated at: 2017-04-19 06:23:50 UTC
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<!-- 다오가 리스트 객체를 가지고 잇으므로 다오로부터 리스트객체를 가져오기 위해 다오를 가지고 있어야 한다. -->\r\n");
   ...
   List<Board> list = dao.listBoard(search);
      ...
      out.write("<body data-genuitec-lp-enabled=\"false\" data-genuitec-file-id=\"wc4-4\" data-genuitec-path=\"/myBatis/WebContent/list.jsp\">\r\n");
      out.write("   <table width=\"500\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" data-genuitec-lp-enabled=\"false\" data-genuitec-file-id=\"wc4-4\" data-genuitec-path=\"/myBatis/WebContent/list.jsp\">\r\n");
      out.write("      <tr>\r\n");
      out.write("         <th>글번호</th>\r\n");
      out.write("         <th>제목</th>\r\n");
      out.write("         <th>작성자</th>\r\n");
...
for(int i=0 ; i<list.size() ; i++){
      ...
      out.write("</td>\r\n");
      out.write("         <!-- board.getSeq()값을 키값으로 가지고 detail.jsp로 간다 -->\r\n");
      ...
      out.write("   \t<input type=\"checkbox\" name=\"area\" value=\"title\">제목</input>\r\n");
      out.write("   \t<input type=\"checkbox\" name=\"area\" value=\"writer\">작성자</input>\r\n");
