...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    ArrayList list = (ArrayList)session.getAttribute("fruit"); 
    %>
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-9" data-genuitec-path="/JSP/WebContent/Mission/mission01/checkOut.jsp">
<%= list.get(i) %>
<%} %>
</body>
</html>