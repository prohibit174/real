...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc4-4" data-genuitec-path="/myBatis/WebContent/list.jsp">
   <table width="500" border="1" cellpadding="0" cellspacing="0" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc4-4" data-genuitec-path="/myBatis/WebContent/list.jsp">
      <tr>
         <th>글번호</th>
         <th>제목</th>
         <th>작성자</th>
