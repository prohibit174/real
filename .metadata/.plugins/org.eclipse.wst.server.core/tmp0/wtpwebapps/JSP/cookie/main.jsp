...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-25" data-genuitec-path="/JSP/WebContent/cookie/main.jsp">
<%= name %> 님 반갑습니다.
<a href="logout.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-25" data-genuitec-path="/JSP/WebContent/cookie/main.jsp">로그아웃</a>
</body>
</html>